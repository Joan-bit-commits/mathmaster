...
TOPICS = {
    ...
    'Matrices & Transformation': (
        'Mathematics',
        'Matrix operations, determinants and geometric transformations.',
    ),
}
...
QUESTIONS = {
    'Introduction to Algebra': [
        (
            ...
            ['An unknown value', 'A number that is always 1', 'A shape', 'A constant'],
            'An unknown value',
        ),
    ...
    'Indices and Standard Form': [
        ...
        (
            ...
            ['4.5 x 10^3', '45 x 10^2', '4.5 x 10^4', '0.45 x 10^4'],
            '4.5 x 10^3',
        ),
    ...
    'Angles and Polygons': [
        (
            'How many degrees are in the angles of a triangle added together?',
            ['90', '180', '270', '360'],
            '180',
        ),
        (
    ...
    'Data Collection and Charts': [
        (
            ...
            ['Bar chart', 'Pie chart', 'Line graph', 'Pictogram'],
            'Pie chart',
        ),
        (
            'Qualitative data is best displayed using:',
            ['Histogram', 'Bar chart of categories', 'Scatter plot', 'Box plot'],
            'Bar chart of categories',
        ),
        (
            'A histogram uses:',
            ['Separate bars for categories', 'Continuous intervals', 'Pictures', 'Lines'],
            'Continuous intervals',
        ),
        ('A line graph is best for showing:', [], 'Trends over time'),
        ('The average of 10, 20 and 30 is:', ['10', '20', '30', '60'], '20'),
    ],
    'Averages: Mean, Mode and Median': [
    ...
    'Trigonometric Ratios': [
        (
            'In a right triangle, sin(theta) equals:',
            ['Opposite/Hypotenuse', 'Adjacent/Hypotenuse', 'Opposite/Adjacent', 'Hypotenuse/Opposite'],
            'Opposite/Hypotenuse',
        ),
        (
            'tan(theta) equals:',
            ['Opposite/Adjacent', 'Adjacent/Opposite', 'Opposite/Hypotenuse', 'Adjacent/Hypotenuse'],
            'Opposite/Adjacent',
        ),
        ...
        (
            'Which ratio would you use to find the hypotenuse from the angle and the adjacent side?',
            ['sin', 'cos', 'tan', 'cot'],
            'cos',
        ),
    ],
    'Applications of Trigonometry': [
        (
            ...
            ['Horizontal up', 'Horizontal down', 'Vertical', 'Object'],
            'Horizontal up',
        ),
        (
            'A 10 m ladder leans at 60 degrees to the ground. Height reached (use sin 60 = 0.87):',
            ['5.0 m', '8.7 m', '10 m', '11.5 m'],
            '8.7 m',
        ),
        ...
        (
            'To find how far a boat is from a cliff, you measure the angle of:',
            ['Depression from the cliff top', 'Elevation from the boat only', 'The horizon', 'The sky'],
            'Depression from the cliff top',
        ),
    ],
    'Set Notation': [
        ...
        (
            'Which of these is a well-defined set?',
            [
                'The set of tall students',
                'The set of even numbers',
                'The set of nice songs',
                'The set of best players',
            ],
            'The set of even numbers',
        ),
        ('If A = {a, b} and B = {b, c}, then A ∩ B =', ['{b}', '{a, b, c}', '{a}', '{}'], '{b}'),
        ('List all subsets of {1, 2}.', [], '{}, {1}, {2}, {1,2}'),
    ],
    'Venn Diagrams': [
        ('If n(A)=10, n(B)=8 and n(A∩B)=3, then n(A∪B)=', ['15', '18', '21', '5'], '15'),
        (
            'The union of two sets contains elements in:',
            ['Either set', 'Both sets only', 'Neither set', 'The first set only'],
            'Either set',
        ),
        ('The intersection of A and B contains elements in:', [], 'Both A and B'),
        (
            'In a class of 40, 25 like maths and 20 like physics, 10 like both. How many like neither?',
            [],
            '5',
        ),
        (
            'The complement of set A contains elements:',
            ['Not in A', 'In A', 'In both A and B', 'In A only'],
            'Not in A',
        ),
    ],
    'Introduction to Matrices': [
        ...
        (
            'If A = [[1,2],[3,4]], then 2A =',
            ['[[2,4],[6,8]]', '[[1,4],[6,4]]', '[[2,2],[3,3]]', '[[1,2],[3,4]]'],
            '[[2,4],[6,8]]',
        ),
        (
            'Matrix addition requires matrices of the same:',
            ['Order', 'Determinant', 'Row only', 'Values'],
            'Order',
        ),
        ('Compute [[1,0],[0,1]] + [[2,3],[4,5]].', [], '[[3,3],[4,6]]'),
        (
            'A 2x3 matrix multiplied by a 3x2 matrix gives a matrix of order:',
            ['2x2', '3x3', '2x3', 'Cannot multiply'],
            '2x2',
        ),
    ],
    'Matrices as Transformations': [
        (
            'The identity matrix represents which transformation?',
            ['No change', 'Rotation', 'Reflection', 'Enlargement'],
            'No change',
        ),
        (
            'The matrix [[-1,0],[0,1]] reflects points in the:',
            ['y-axis', 'x-axis', 'origin', 'line y=x'],
            'y-axis',
        ),
        ('A rotation matrix for 90 degrees maps (1,0) to:', ['(0,1)', '(0,-1)', '(1,0)', '(-1,0)'], '(0,1)'),
        ('The determinant of [[2,0],[0,3]] is:', [], '6'),
        ('A matrix that maps every point to the origin has determinant:', ['0', '1', '-1', 'undefined'], '0'),
    ],
}
