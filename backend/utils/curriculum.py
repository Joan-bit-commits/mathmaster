...
QUESTIONS = {
    ...
    'Trigonometric Ratios': [
        ...
        ('Which ratio would you use to find the hypotenuse from the angle and the adjacent side?', ['sin', 'cos', 'tan', 'cot'], 'cos'),
    ],
    'Applications of Trigonometry': [
        ...
        ('To find how far a boat is from a cliff, you measure the angle of:', ['Depression from the cliff top', 'Elevation from the boat only', 'The horizon', 'The sky'], 'Depression from the cliff top'),
    ],
    'Set Notation': [
        ('If A = {1, 2, 3}, the number of elements (n(A)) is:', ['2', '3', '4', '5'], '3'),
        ('The symbol for "is a member of" is:', ['U', '∈', '⊂', '∅'], '∈'),
        ('The empty set is written as:', ['{0}', '∅', 'U', 'A'], '∅'),
        ('Which of these is a well-defined set?', ['The set of tall students', 'The set of even numbers', 'The set of nice songs', 'The set of best players'], 'The set of even numbers'),
    ...
    'Venn Diagrams': [
        ...
        ('The complement of set A contains elements:', ['Not in A', 'In A', 'In both A and B', 'In A only'], 'Not in A'),
    ],
    'Introduction to Matrices': [
        ...
        ('A 2x3 matrix multiplied by a 3x2 matrix gives a matrix of order:', ['2x2', '3x3', '2x3', 'Cannot multiply'], '2x2'),
    ],
    'Matrices as Transformations': [
