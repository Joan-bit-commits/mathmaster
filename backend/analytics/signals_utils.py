...
def teacher_overview():
    ...
    return {
        ...
        # The mobile teacher dashboard's "Overview" stat grid already reads
        # overview.coverage.{topics,lessons,quizzes} — this field just
        # never existed here, so those tiles always silently showed 0.
        'coverage': {
