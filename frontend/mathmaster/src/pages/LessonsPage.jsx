    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(14,165,233,0.16),_transparent_34%),linear-gradient(180deg,_#f8fafc_0%,_#eef2ff_100%)] text-slate-950">
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <section className="mb-8 rounded-[2rem] border border-slate-200 bg-white/90 p-8 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-sky-600">Lessons</p>
          <h1 className="mt-3 text-4xl font-semibold tracking-tight">Choose a lesson</h1>
          <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-600">
            Read through the lesson content and move into quizzes when you are ready.
          </p>
        </section>
          ...
          <div className="grid gap-4">
            {lessons.map((lesson) => (
              ...
              >
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">{lesson.content.substring(0, 120)}...</p>
              </Link>
            ))}
          </div>
        )}
