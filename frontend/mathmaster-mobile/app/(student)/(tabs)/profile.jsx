...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { icon: 'mail', label: 'Email & notifications', route: '/(shared)/settings' },
    ],
  },
  {
    title: 'Learning',
    items: [
      { icon: 'history', label: 'AI tutor history', route: '/(student)/ai-tutor/history' },
      { icon: 'leaderboard', label: 'Performance detail', route: '/(student)/performance/all' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'download', label: 'Offline content', route: '/(shared)/offline' },
    ],
  },
  {
    title: 'Support & About',
...
export default function StudentProfileScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background" accessibilityLabel="Student profile">
      <Screen>
        <ScrollView contentContainerClassName="px-[24px] pb-10" showsVerticalScrollIndicator={false}>
          <View className="items-center py-6">
            ...
            <Text accessibilityRole="header" className="text-[24px] leading-8 font-semibold text-on-surface mt-3">
